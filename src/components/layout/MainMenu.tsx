...
const MainMenu = () => {
    return (
        <div className="container">
            <div className="mt-8 max-md:hidden flex items-center gap-x-8">
                ...
                <div className="relative whitespace-nowrap overflow-auto page__scroll--hidden flex items-center gap-x-10">
